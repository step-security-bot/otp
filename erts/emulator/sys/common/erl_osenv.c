...
static int destroy_foreach(env_rbtnode_t *node, void *_state) {
...
static int merge_foreach(env_rbtnode_t *node, void *_state) {
...
static int foreach_term_wrapper(env_rbtnode_t *node, void *_state) {
...
static int foreach_native_wrapper(env_rbtnode_t *node, void *_state) {
