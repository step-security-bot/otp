...
static int link_port_exit(ErtsLink *lnk, void *vpectxt)
{
...
static int monitor_port_exit(ErtsMonitor *mon, void *vpectxt)
{
    ErtsPortExitContext *pectxt = vpectxt;
...
static int prt_one_monitor(ErtsMonitor *mon, void *vprtd)
{
    ErtsMonitorData *mdp = erts_monitor_to_data(mon);
...
static int prt_one_lnk(ErtsLink *lnk, void *vprtd)
{
    prt_one_lnk_data *prtd = (prt_one_lnk_data *) vprtd;
