...
static int do_calc_mon_size(ErtsMonitor *mon, void *vpsz)
{
...
static int do_make_one_mon_element(ErtsMonitor *mon, void * vpmlc)
{
    ErtsMonitorData *mdp = erts_monitor_to_data(mon);
...
static int calc_lnk_size(ErtsLink *lnk, void *vpsz)
{
    Uint *psz = vpsz;
    Uint sz = 0;
...
static int make_one_lnk_element(ErtsLink *lnk, void * vpllc)
{
...
static int collect_one_link(ErtsLink *lnk, void *vmicp)
{
...
static int collect_one_origin_monitor(ErtsMonitor *mon, void *vmicp)
{
...
static int collect_one_target_monitor(ErtsMonitor *mon, void *vmicp)
{
    MonitorInfoCollection *micp = vmicp;
...
static int monitor_size(ErtsMonitor *mon, void *vsz)
{
    *((Uint *) vsz) = erts_monitor_size(mon);
    return 1;
}

static int link_size(ErtsMonitor *lnk, void *vsz)
{
