...
int ERTS_NOINLINE erts_check_below_limit(char *ptr, char *limit);
int ERTS_NOINLINE erts_check_above_limit(char *ptr, char *limit);
void *ERTS_NOINLINE erts_ptr_id(void *ptr);
