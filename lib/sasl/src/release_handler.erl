...
%%                   exit_reason()
%%-----------------------------------------------------------------
%% -spec install_release(Vsn) -> {ok, OtherVsn, Descr} | {error, Reason} when Vsn :: string(),
%%    OtherVsn :: string(),
...
%% -spec install_release(Vsn, [Opt]) -> {ok, OtherVsn, Descr} | {continue_after_restart, OtherVsn, Descr} | {error, Reason} when Vsn :: string(),
%%    OtherVsn :: string(),
%%    Opt :: {error_action, Action} | {code_change_timeout, Timeout},
%%     Action :: restart | reboot,
%%     Timeout :: default | infinity | pos_integer(),
...
%% -spec create_RELEASES(RelDir, RelFile, AppDirs) -> ok | {error, Reason} when Root :: string(),
%%    RelDir :: string(),
%%    RelFile :: string(),
%%    AppDirs :: [{App, Vsn, Dir}],
%%     App :: atom(),
