...
-doc "Invokes `et:trace_me/5` with both `From` and `To` set to `FromTo`.".
...
-doc "These functions sends a signal to the outer space and the caller hopes that someone is listening. In other words, they invoke `et:trace_me/4` and `et:trace_me/5` respectively.".
...
-doc "Deprecated functions which for the time being are kept for backwards compatibility. Invokes `et:trace_me/4` and `et:trace_me/5` respectively.".
