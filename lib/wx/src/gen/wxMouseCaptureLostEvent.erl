...
See: `m:wxMouseCaptureChangedEvent`, [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events), `wxWindow:captureMouse/1`, `wxWindow:releaseMouse/1`, `wxWindow:getCapture/0`

This class is derived (and can use functions) from: `m:wxEvent`

wxWidgets docs: [wxMouseCaptureLostEvent](https://docs.wxwidgets.org/3.1/classwx_mouse_capture_lost_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxMouseCaptureLostEventType`](`t:wxMouseCaptureLostEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
-export([]).
