...
See: `m:wxScrollEvent`, [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events)

This class is derived (and can use functions) from: `m:wxEvent`

wxWidgets docs: [wxScrollWinEvent](https://docs.wxwidgets.org/3.1/classwx_scroll_win_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxScrollWinEventType`](`t:wxScrollWinEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
