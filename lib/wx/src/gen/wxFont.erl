...
See: [Overview font](https://docs.wxwidgets.org/3.1/overview_font.html#overview_font), `wxDC:setFont/2`, `wxDC:drawText/3`, `wxDC:getTextExtent/3`, `m:wxFontDialog`, `m:wxSystemSettings`
...
See: [Overview fontencoding](https://docs.wxwidgets.org/3.1/overview_fontencoding.html#overview_fontencoding), `setDefaultEncoding/1`
""".
...
If the current font face name is not recognized by `m:wxFont` or by the underlying system, `wxFONTFAMILY_DEFAULT` is returned.
...
Note that the returned string is not meant to be shown or edited by the user: a typical use of this function is for serializing in string-form a `m:wxFont` object.
...
The string does not encode all `m:wxFont` infos under all platforms; e.g. under wxMSW the font family is not present in the returned string.
...
See: [Overview fontencoding](https://docs.wxwidgets.org/3.1/overview_fontencoding.html#overview_fontencoding), `getDefaultEncoding/0`
""".
