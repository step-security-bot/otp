...
See: `m:wxDataObject`, `wxDataObjectSimple` (not implemented in wx), `m:wxTextDataObject`, `m:wxBitmapDataObject`, `m:wxDataObject`

This class is derived (and can use functions) from: `m:wxDataObject`

wxWidgets docs: [wxFileDataObject](https://docs.wxwidgets.org/3.1/classwx_file_data_object.html)
""".
-include("wxe.hrl").
