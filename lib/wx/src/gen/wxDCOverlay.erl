...
wxWidgets docs: [wxDCOverlay](https://docs.wxwidgets.org/3.1/classwx_d_c_overlay.html)
""".
-include("wxe.hrl").
...
%% @doc See <a href="http://www.wxwidgets.org/manuals/2.8.12/wx_wxdcoverlay.html#wxdcoverlaywxdcoverlay">external documentation</a>.
-doc "Connects this overlay to the corresponding drawing dc, if the overlay is not initialized yet this call will do so.".
