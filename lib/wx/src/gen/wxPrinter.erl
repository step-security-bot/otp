...
See: [Overview printing](https://docs.wxwidgets.org/3.1/overview_printing.html#overview_printing), `wxPrinterDC` (not implemented in wx), `m:wxPrintDialog`, `m:wxPrintout`, `m:wxPrintPreview`
...
Provide a parent window, a user-defined `m:wxPrintout` object which controls the printing of a document, and whether the print dialog should be invoked first.
