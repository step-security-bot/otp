...
See: [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events), `wxWindow:show/2`, `wxWindow:isShown/1`

This class is derived (and can use functions) from: `m:wxEvent`

wxWidgets docs: [wxShowEvent](https://docs.wxwidgets.org/3.1/classwx_show_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxShowEventType`](`t:wxShowEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
