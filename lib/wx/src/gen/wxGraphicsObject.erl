...
See: `m:wxGraphicsBrush`, `m:wxGraphicsPen`, `m:wxGraphicsMatrix`, `m:wxGraphicsPath`

wxWidgets docs: [wxGraphicsObject](https://docs.wxwidgets.org/3.1/classwx_graphics_object.html)
""".
-include("wxe.hrl").
...
-doc "Returns the renderer that was used to create this instance, or NULL if it has not been initialized yet.".
