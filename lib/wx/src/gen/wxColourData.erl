...
See: [`wx_color()`](`t:wx:wx_colour/0`), `m:wxColourDialog`, [Overview cmndlg](https://docs.wxwidgets.org/3.1/overview_cmndlg.html#overview_cmndlg_colour)

wxWidgets docs: [wxColourData](https://docs.wxwidgets.org/3.1/classwx_colour_data.html)
""".
-include("wxe.hrl").
