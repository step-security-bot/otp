...
This class holds information related to the visual characteristics of `m:wxPrintDialog`. It contains a `m:wxPrintData` object with underlying printing settings.

See: [Overview printing](https://docs.wxwidgets.org/3.1/overview_printing.html#overview_printing), `m:wxPrintDialog`, [Overview cmndlg](https://docs.wxwidgets.org/3.1/overview_cmndlg.html#overview_cmndlg_print)

wxWidgets docs: [wxPrintDialogData](https://docs.wxwidgets.org/3.1/classwx_print_dialog_data.html)
""".
-include("wxe.hrl").
