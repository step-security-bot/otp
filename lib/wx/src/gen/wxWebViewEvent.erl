...
wxWidgets docs: [wxWebViewEvent](https://docs.wxwidgets.org/3.1/classwx_web_view_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxWebViewEventType`](`t:wxWebViewEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
