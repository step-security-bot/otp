...
A `m:wxSetCursorEvent` is generated from `m:wxWindow` when the mouse cursor is about to be set as a result of mouse motion.
...
wxWidgets docs: [wxSetCursorEvent](https://docs.wxwidgets.org/3.1/classwx_set_cursor_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxSetCursorEventType`](`t:wxSetCursorEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
