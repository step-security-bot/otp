...
wxWidgets docs: [wxHtmlLinkEvent](https://docs.wxwidgets.org/3.1/classwx_html_link_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxHtmlLinkEventType`](`t:wxHtmlLinkEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
...
-doc "Returns the [`wx_wxHtmlLinkInfo()`](`t:wx:wx_wxHtmlLinkInfo/0`) which contains info about the cell clicked and the hyperlink it contains.".
