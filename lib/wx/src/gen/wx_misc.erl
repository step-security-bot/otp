...
Returns a [`wx_wxMouseState()`](`t:wx:wx_wxMouseState/0`) instance that contains the current position of the mouse pointer in screen coordinates, as well as boolean values indicating the up/down status of the mouse buttons and the modifier keys.
""".
...
See: `wxExecute()` (not implemented in wx), [Examples](https://docs.wxwidgets.org/3.1/page_samples.html#page_samples_exec)
""".
...
-doc "Ensures that Ids subsequently generated by `newId/0` do not clash with the given `id`.".
