...
See: [Overview bookctrl](https://docs.wxwidgets.org/3.1/overview_bookctrl.html#overview_bookctrl)

This class is derived (and can use functions) from: `m:wxControl` `m:wxWindow` `m:wxEvtHandler`

wxWidgets docs: [wxBookCtrlBase](https://docs.wxwidgets.org/3.1/classwx_book_ctrl_base.html)
""".
-include("wxe.hrl").
