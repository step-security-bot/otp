...
See: `m:wxGridCellRenderer`, `wxGridCellAutoWrapStringRenderer` (not implemented in wx), `wxGridCellDateTimeRenderer` (not implemented in wx), `wxGridCellEnumRenderer` (not implemented in wx), `m:wxGridCellFloatRenderer`, `m:wxGridCellNumberRenderer`, `m:wxGridCellStringRenderer`

This class is derived (and can use functions) from: `m:wxGridCellRenderer`

wxWidgets docs: [wxGridCellBoolRenderer](https://docs.wxwidgets.org/3.1/classwx_grid_cell_bool_renderer.html)
""".
-include("wxe.hrl").
