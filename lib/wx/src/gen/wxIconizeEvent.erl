...
See: [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events), `wxTopLevelWindow:iconize/2`, `wxTopLevelWindow:isIconized/1`

This class is derived (and can use functions) from: `m:wxEvent`

wxWidgets docs: [wxIconizeEvent](https://docs.wxwidgets.org/3.1/classwx_iconize_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxIconizeEventType`](`t:wxIconizeEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
-export([isIconized/1]).
