...
See: [Overview cmndlg](https://docs.wxwidgets.org/3.1/overview_cmndlg.html#overview_cmndlg_font), `m:wxFont`, `m:wxFontDialog`

wxWidgets docs: [wxFontData](https://docs.wxwidgets.org/3.1/classwx_font_data.html)
""".
-include("wxe.hrl").
...
-doc "Gets the font chosen by the user if the user pressed OK (`wxFontDialog::ShowModal()` (not implemented in wx) returned wxID_OK).".
