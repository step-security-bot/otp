...
wxWidgets docs: [wxNotificationMessage](https://docs.wxwidgets.org/3.1/classwx_notification_message.html)

## Events

Event types emitted from this class: [`notification_message_click`](`m:wxCommandEvent`), [`notification_message_dismissed`](`m:wxCommandEvent`), [`notification_message_action`](`m:wxCommandEvent`)
""".
-include("wxe.hrl").
...
-doc "Default constructor, use `setParent/2`, `setTitle/2` and `setMessage/2` to initialize the object before showing it.".
...
-doc "Set the parent for this notification: the notification will be associated with the top level parent of this window or, if this method is not called, with the main application window by default.".
...
-doc "Set the title, it must be a concise string (not more than 64 characters), use `setMessage/2` to give the user more details.".
...
-doc """
If the application already uses a `m:wxTaskBarIcon`, it should be connected to notifications by using this method.
