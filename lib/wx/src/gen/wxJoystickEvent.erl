...
wxWidgets docs: [wxJoystickEvent](https://docs.wxwidgets.org/3.1/classwx_joystick_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxJoystickEventType`](`t:wxJoystickEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
...
-doc "Returns the identifier of the joystick generating the event - one of wxJOYSTICK1 and wxJOYSTICK2.".
