...
wxWidgets docs: [wxCommandEvent](https://docs.wxwidgets.org/3.1/classwx_command_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxCommandEventType`](`t:wxCommandEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
...
-doc "Returns client object pointer for a listbox or choice selection event (not valid for a deselection).".
