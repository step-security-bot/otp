...
See: [Overview dnd](https://docs.wxwidgets.org/3.1/overview_dnd.html#overview_dnd), [Overview dataobject](https://docs.wxwidgets.org/3.1/overview_dataobject.html#overview_dataobject), `m:wxDataObject`

wxWidgets docs: [wxClipboard](https://docs.wxwidgets.org/3.1/classwx_clipboard.html)
""".
-include("wxe.hrl").
...
-doc """
On platforms supporting it (all X11-based ports), `m:wxClipboard` uses the CLIPBOARD X11 selection by default.
...
-doc "Returns true if there is data which matches the data format of the given data object currently `available` on the clipboard.".
