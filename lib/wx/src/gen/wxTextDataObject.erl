...
See: [Overview dnd](https://docs.wxwidgets.org/3.1/overview_dnd.html#overview_dnd), `m:wxDataObject`, `wxDataObjectSimple` (not implemented in wx), `m:wxFileDataObject`, `m:wxBitmapDataObject`

This class is derived (and can use functions) from: `m:wxDataObject`

wxWidgets docs: [wxTextDataObject](https://docs.wxwidgets.org/3.1/classwx_text_data_object.html)
""".
-include("wxe.hrl").
...
-doc "Constructor, may be used to initialise the text (otherwise `setText/2` should be used later).".
...
You may wish to override this method when offering data on-demand, but this is not required by wxWidgets' internals. Use this method to get data in text form from the `m:wxClipboard`.
""".
