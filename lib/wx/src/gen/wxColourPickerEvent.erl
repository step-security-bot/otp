...
wxWidgets docs: [wxColourPickerEvent](https://docs.wxwidgets.org/3.1/classwx_colour_picker_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxColourPickerEventType`](`t:wxColourPickerEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
-export([getColour/1]).
