...
wxWidgets docs: [wxGraphicsGradientStops](https://docs.wxwidgets.org/3.1/classwx_graphics_gradient_stops.html)
""".
-include("wxe.hrl").
...
Creates a `m:wxGraphicsGradientStops` instance with start colour given by `startCol` and end colour given by `endCol`.
""".
