...
Note that you usually don't have to deal with it directly as `m:wxMenu` methods usually construct an object of this class for you.
...
wxWidgets docs: [wxMenuItem](https://docs.wxwidgets.org/3.1/classwx_menu_item.html)

## Events

Event types emitted from this class: [`menu_open`](`m:wxMenuEvent`), [`menu_close`](`m:wxMenuEvent`), [`menu_highlight`](`m:wxMenuEvent`)
""".
-include("wxe.hrl").
...
-doc "Returns the item kind, one of `wxITEM_SEPARATOR`, `wxITEM_NORMAL`, `wxITEM_CHECK` or `wxITEM_RADIO`.".
