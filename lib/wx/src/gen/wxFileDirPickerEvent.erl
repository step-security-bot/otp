...
wxWidgets docs: [wxFileDirPickerEvent](https://docs.wxwidgets.org/3.1/classwx_file_dir_picker_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxFileDirPickerEventType`](`t:wxFileDirPickerEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
-export([getPath/1]).
