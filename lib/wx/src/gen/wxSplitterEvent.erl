...
See: `m:wxSplitterWindow`, [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events)

This class is derived (and can use functions) from: `m:wxNotifyEvent` `m:wxCommandEvent` `m:wxEvent`

wxWidgets docs: [wxSplitterEvent](https://docs.wxwidgets.org/3.1/classwx_splitter_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxSplitterEventType`](`t:wxSplitterEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
