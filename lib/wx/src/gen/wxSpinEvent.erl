...
wxWidgets docs: [wxSpinEvent](https://docs.wxwidgets.org/3.1/classwx_spin_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxSpinEventType`](`t:wxSpinEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
