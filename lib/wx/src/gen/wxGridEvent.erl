...
wxWidgets docs: [wxGridEvent](https://docs.wxwidgets.org/3.1/classwx_grid_event.html)

## Events

Use `wxEvtHandler:connect/3` with [`wxGridEventType`](`t:wxGridEventType/0`) to subscribe to events of this type.
""".
-include("wxe.hrl").
