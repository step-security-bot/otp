...
See: [Overview events](https://docs.wxwidgets.org/3.1/overview_events.html#overview_events), `m:wxWindowCreateEvent`

This class is derived (and can use functions) from: `m:wxCommandEvent` `m:wxEvent`

wxWidgets docs: [wxWindowDestroyEvent](https://docs.wxwidgets.org/3.1/classwx_window_destroy_event.html)
""".
-include("wxe.hrl").
-export([]).
