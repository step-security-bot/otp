...
See: [Overview xrc](https://docs.wxwidgets.org/3.1/overview_xrc.html#overview_xrc), [Overview xrcformat](https://docs.wxwidgets.org/3.1/overview_xrcformat.html#overview_xrcformat)

wxWidgets docs: [wxXmlResource](https://docs.wxwidgets.org/3.1/classwxXml_resource.html)
""".
-include("wxe.hrl").
...
-doc "Removes all handlers and deletes them (this means that any handlers added using `AddHandler()` (not implemented in wx) must be allocated on the heap).".
