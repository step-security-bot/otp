...
%% -spec enable() -> ok | {error, Res} when Dir :: string(),
%%    Conf :: string(),
%%    Res :: string().
enable() ->
    command(enable).
%% -spec enable(Dir, Conf) -> ok | {error, Error} when Dir :: string(),
%%    Conf :: string(),
%%    Res :: string().
enable(Path, Conf) ->
    command(enable, Path, Conf).

%% -spec disable() -> ok | {error, Res} when Dir :: string(),
%%    Conf :: string(),
%%    Res :: string().
disable() ->
    command(disable).
%% -spec disable(Dir, Conf) -> ok | {error, Error} when Dir :: string(),
%%    Conf :: string(),
%%    Res :: string().
disable(Path, Conf) ->
