...
-doc "Equivalent to [export(Data, Callback, [])](`export/3`).".
...
-doc "Equivalent to [export_simple(Content, Callback, [])](`export_simple/3`).".
...
%% document. 
-doc "For on-the-fly exporting during parsing (SAX style) of the XML document.".
