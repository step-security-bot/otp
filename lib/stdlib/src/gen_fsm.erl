...
[](){: id="Migration to gen_statem" }
## Migration to gen_statem

Here follows a simple example of turning a gen_fsm into a `m:gen_statem`. The example comes from the previous Users Guide for `gen_fsm`
