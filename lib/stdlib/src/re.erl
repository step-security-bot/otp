...
The [regular expression](`m:re#regexp_syntax`) syntax and semantics resemble that of Perl.
...
* __(*CR)__ - Carriage return

* __(*LF)__ - Line feed

* __(*CRLF)__ - >Carriage return followed by line feed

* __(*ANYCRLF)__ - Any of the three above

* __(*ANY)__ - All Unicode newline sequences
...
* __\\__ - General escape character with many uses

* __^__ - Assert start of string (or line, in multiline mode)

* __$__ - Assert end of string (or line, in multiline mode)

* __.__ - Match any character except newline (by default)

* __[__ - Start character class definition

* __|__ - Start of alternative branch

* __(__ - Start subpattern

* __)__ - End subpattern

* __?__ - Extends the meaning of (, also 0 or 1 quantifier, also quantifier minimizer

* __*__ - 0 or more quantifiers

* __+__ - 1 or more quantifier, also "possessive quantifier"

* __\{__ - Start min/max quantifier
...
* __\\__ - General escape character

* __^__ - Negate the class, but only if the first character

* __-__ - Indicates character range

* __[__ - Posix character class (only if followed by Posix syntax)

* __]__ - Terminates the character class
...
* __\\a__ - Alarm, that is, the BEL character (hex 07)

* __\\cx__ - "Control-x", where x is any ASCII character

* __\\e__ - Escape (hex 1B)

* __\\f__ - Form feed (hex 0C)

* __\\n__ - Line feed (hex 0A)

* __\\r__ - Carriage return (hex 0D)

* __\\t__ - Tab (hex 09)

* __\\0dd__ - Character with octal code 0dd

* __\\ddd__ - Character with octal code ddd, or back reference

* __\\o\{ddd..\}__ - character with octal code ddd..

* __\\xhh__ - Character with hex code hh

* __\\x\{hhh..\}__ - Character with hex code hhh..
...
* __\\040__ - Another way of writing an ASCII space

* __\\40__ - The same, provided there are < 40 previous capturing subpatterns

* __\\7__ - Always a back reference

* __\\11__ - Can be a back reference, or another way of writing a tab

* __\\011__ - Always a tab

* __\\0113__ - A tab followed by character "3"

* __\\113__ - Can be a back reference, otherwise the character with octal code 113

* __\\377__ - Can be a back reference, otherwise value 255 (decimal)

* __\\81__ - Either a back reference, or the two characters "8" and "1"
...
* __8-bit non-UTF mode__ - < 0x100

* __8-bit UTF-8 mode__ - < 0x10ffff and a valid codepoint
...
* __\\d__ - Any decimal digit

* __\\D__ - Any character that is not a decimal digit

* __\\h__ - Any horizontal whitespace character

* __\\H__ - Any character that is not a horizontal whitespace character

* __\\s__ - Any whitespace character

* __\\S__ - Any character that is not a whitespace character

* __\\v__ - Any vertical whitespace character

* __\\V__ - Any character that is not a vertical whitespace character

* __\\w__ - Any "word" character

* __\\W__ - Any "non-word" character
...
* __\\d__ - Any character that \\p\{Nd\} matches (decimal digit)

* __\\s__ - Any character that \\p\{Z\} or \\h or \\v

* __\\w__ - Any character that matches \\p\{L\} or \\p\{N\} matches, plus underscore
...
* __U+0009__ - Horizontal tab (HT)

* __U+0020__ - Space

* __U+00A0__ - Non-break space

* __U+1680__ - Ogham space mark

* __U+180E__ - Mongolian vowel separator
...
* __U+2004__ - Three-per-em space

* __U+2005__ - Four-per-em space

* __U+2006__ - Six-per-em space

* __U+2007__ - Figure space

* __U+2008__ - Punctuation space

* __U+2009__ - Thin space

* __U+200A__ - Hair space

* __U+202F__ - Narrow no-break space

* __U+205F__ - Medium mathematical space

* __U+3000__ - Ideographic space

The following are the vertical space characters:

* __U+000A__ - Line feed (LF)

* __U+000B__ - Vertical tab (VT)

* __U+000C__ - Form feed (FF)

* __U+000D__ - Carriage return (CR)

* __U+0085__ - Next line (NEL)

* __U+2028__ - Line separator

* __U+2029__ - Paragraph separator
...
* __(*BSR_ANYCRLF)__ - CR, LF, or CRLF only

* __(*BSR_UNICODE)__ - Any Unicode newline sequence
...
* __\\p\{*xx*\}__ - A character with property *xx*

* __\\P\{*xx*\}__ - A character without property *xx*

* __\\X__ - A Unicode extended grapheme cluster
...
* __Ll__ - Lowercase letter

* __Lm__ - Modifier letter

* __Lo__ - Other letter

* __Lt__ - Title case letter

* __Lu__ - Uppercase letter

* __M__ - Mark

* __Mc__ - Spacing mark

* __Me__ - Enclosing mark

* __Mn__ - Non-spacing mark

* __N__ - Number

* __Nd__ - Decimal number

* __Nl__ - Letter number

* __No__ - Other number

* __P__ - Punctuation

* __Pc__ - Connector punctuation

* __Pd__ - Dash punctuation

* __Pe__ - Close punctuation

* __Pf__ - Final punctuation

* __Pi__ - Initial punctuation

* __Po__ - Other punctuation

* __Ps__ - Open punctuation

* __S__ - Symbol

* __Sc__ - Currency symbol

* __Sk__ - Modifier symbol

* __Sm__ - Mathematical symbol

* __So__ - Other symbol

* __Z__ - Separator

* __Zl__ - Line separator

* __Zp__ - Paragraph separator

* __Zs__ - Space separator
...
1. Do not break Hangul (a Korean script) syllable sequences. Hangul characters are of five types: L, V, T, LV, and LVT. An L character can be followed by an L, V, LV, or LVT character. An LV or V character can be followed by a V or T character. An LVT or T character can be followed only by a T character.
1. Do not end before extending characters or spacing marks. Characters with the "mark" property always have the "extend" grapheme breaking property.
...
* __Xan__ - Any alphanumeric character. Matches characters that have either the L (letter) or the N (number) property.

* __Xps__ - Any Posix space character. Matches the characters tab, line feed, vertical tab, form feed, carriage return, and any other character that has the Z (separator) property.

* __Xsp__ - Any Perl space character. Matches the same as Xps, except that vertical tab is excluded.

* __Xwd__ - Any Perl "word" character. Matches the same characters as Xan, plus underscore.
...
* __\\b__ - Matches at a word boundary.

* __\\B__ - Matches when not at a word boundary.

* __\\A__ - Matches at the start of the subject.

* __\\Z__ - Matches at the end of the subject, and before a newline at the end of the subject.

* __\\z__ - Matches only at the end of the subject.

* __\\G__ - Matches at the first matching position in the subject.
...
* __alnum__ - Letters and digits

* __alpha__ - Letters

* __blank__ - Space or tab only

* __cntrl__ - Control characters

* __digit__ - Decimal digits (same as \\d)

* __graph__ - Printing characters, excluding space

* __lower__ - Lowercase letters

* __print__ - Printing characters, including space

* __punct__ - Printing characters, excluding letters, digits, and space

* __space__ - Whitespace (the same as \\s from PCRE 8.34)

* __upper__ - Uppercase letters

* __word__ - "Word" characters (same as \\w)

* __xdigit__ - Hexadecimal digits
...
* __\[:alnum:]__ - Becomes *\\p\{Xan\}*

* __\[:alpha:]__ - Becomes *\\p\{L\}*

* __\[:blank:]__ - Becomes *\\h*

* __\[:digit:]__ - Becomes *\\p\{Nd\}*

* __\[:lower:]__ - Becomes *\\p\{Ll\}*

* __\[:space:]__ - Becomes *\\p\{Xps\}*

* __\[:upper:]__ - Becomes *\\p\{Lu\}*

* __\[:word:]__ - Becomes *\\p\{Xwd\}*

Negated versions, such as \[:^alpha:], use \\P instead of \\p. Three other POSIX classes are handled specially in UCP mode:

* __\[:graph:]__ - This matches characters that have glyphs that mark the page when printed. In Unicode property terms, it matches all characters with the L, M, N, P, S, or Cf properties, except for:

  * __U+061C__ - Arabic Letter Mark

  * __U+180E__ - Mongolian Vowel Separator

  * __U+2066 - U+2069__ - Various "isolate"s

  

* __\[:print:]__ - This matches the same characters as \[:graph:] plus space characters that are not controls, that is, characters with the Zs property.

* __\[:punct:]__ - This matches all characters that have the Unicode P (punctuation) property, plus those characters whose code points are less than 128 that have the S (Symbol) property.
...
An option change within a subpattern (see section [Subpatterns](`m:re#sect11`)) affects only that part of the subpattern that follows it. So, the following matches abc and aBc and no other strings (assuming `caseless` is not used):
...
* __1.__ - It localizes a set of alternatives. For example, the following pattern matches "cataract", "caterpillar", or "cat":
...
* __2.__ - It sets up the subpattern as a capturing subpattern. That is, when the complete pattern matches, that portion of the subject string that matched the subpattern is passed back to the caller through the return value of `run/3`.
...
The quantifier \{0\} is permitted, causing the expression to behave as if the previous item and the quantifier were not present. This can be useful for subpatterns that are referenced as subroutines from elsewhere in the pattern (but see also section [Defining Subpatterns for Use by Reference Only](`m:re#defining_subpatterns`)). Items other than subpatterns that have a \{0\} quantifier are omitted from the compiled pattern.

For convenience, the three most common quantifiers have single-character abbreviations:

* __*__ - Equivalent to \{0,\}

* __+__ - Equivalent to \{1,\}

* __?__ - Equivalent to \{0,1\}
...
It is not possible to have a numerical "forward back reference" to a subpattern whose number is 10 or more using this syntax, as a sequence such as \\50 is interpreted as a character defined in octal. For more details of the handling of digits following a backslash, see section [Non-Printing Characters](`m:re#non_printing_characters`) earlier. There is no such problem when named parentheses are used. A back reference to any subpattern is possible using named parentheses (see below).
...
A back reference matches whatever matched the capturing subpattern in the current subject string, rather than anything matching the subpattern itself (section [Subpattern as Subroutines](`m:re#sect21`) describes a way of doing that). So, the following pattern matches "sense and sensibility" and "response and responsibility", but not "sense and responsibility":
...
> #### Note {: class=info }
> In Erlang, there is no interface to retrieve a mark with [`run/2,3`](`run/2`), so only the secondary purpose is relevant to the Erlang programmer.
>
...
If (*COMMIT) is the only backtracking verb that is encountered, once it has been passed, [`run/2,3`](`run/2`) is committed to find a match at the current starting point, or not at all, for example:
...
-doc "Opaque data type containing a compiled regular expression. `t:mp()` is guaranteed to be a tuple() having the atom `re_pattern` as its first element, to allow for matching in guards. The arity of the tuple or the content of the other fields can change in future Erlang/OTP releases.".
...
-doc "The return of this function is a string with the PCRE version of the system that was used in the Erlang/OTP compilation.".
-doc(#{since => <<"OTP 20.0">>}).
-spec version() -> binary().
...
-doc "The same as `compile(Regexp,[])`".
...
When option `unicode` is specified, the regular expression is to be specified as a valid Unicode `charlist()`, otherwise as any valid `t:iodata()`.

[](){: id=compile_options }
Options:

* __`unicode`__ - The regular expression is specified as a Unicode `charlist()` and the resulting regular expression code is to be run against a valid Unicode `charlist()` subject. Also consider option `ucp` when using Unicode characters.

* __`anchored`__ - The pattern is forced to be "anchored", that is, it is constrained to match only at the first matching point in the string that is searched (the "subject string"). This effect can also be achieved by appropriate constructs in the pattern itself.

* __`caseless`__ - Letters in the pattern match both uppercase and lowercase letters. It is equivalent to Perl option `/i` and can be changed within a pattern by a `(?i)` option setting. Uppercase and lowercase letters are defined as in the ISO 8859-1 character set.

* __`dollar_endonly`__ - A dollar metacharacter in the pattern matches only at the end of the subject string. Without this option, a dollar also matches immediately before a newline at the end of the string (but not before any other newlines). This option is ignored if option `multiline` is specified. There is no equivalent option in Perl, and it cannot be set within a pattern.

* __`dotall`__ - A dot in the pattern matches all characters, including those indicating newline. Without it, a dot does not match when the current position is at a newline. This option is equivalent to Perl option `/s` and it can be changed within a pattern by a `(?s)` option setting. A negative class, such as `[^a]`, always matches newline characters, independent of the setting of this option.

* __`extended`__ - If this option is set, most white space characters in the pattern are totally ignored except when escaped or inside a character class. However, white space is not allowed within sequences such as `(?>` that introduce various parenthesized subpatterns, nor within a numerical quantifier such as `{1,3}`. However, ignorable white space is permitted between an item and a following quantifier and between a quantifier and a following + that indicates possessiveness.
...
* __`no_auto_capture`__ - Disables the use of numbered capturing parentheses in the pattern. Any opening parenthesis that is not followed by `?` behaves as if it is followed by `?:`. Named parentheses can still be used for capturing (and they acquire numbers in the usual way). There is no equivalent option in Perl.

* __`dupnames`__ - Names used to identify capturing subpatterns need not be unique. This can be helpful for certain types of pattern when it is known that only one instance of the named subpattern can ever be matched. More details of named subpatterns are provided below.

* __`ungreedy`__ - Inverts the "greediness" of the quantifiers so that they are not greedy by default, but become greedy if followed by "?". It is not compatible with Perl. It can also be set by a `(?U)` option setting within the pattern.

* __`{newline, NLSpec}`__ - Overrides the default definition of a newline in the subject string, which is LF (ASCII 10) in Erlang.

  * __`cr`__ - Newline is indicated by a single character `cr` (ASCII 13).

  * __`lf`__ - Newline is indicated by a single character LF (ASCII 10), the default.

  * __`crlf`__ - Newline is indicated by the two-character CRLF (ASCII 13 followed by ASCII 10) sequence.

  * __`anycrlf`__ - Any of the three preceding sequences is to be recognized.

  * __`any`__ - Any of the newline sequences above, and the Unicode sequences VT (vertical tab, U+000B), FF (formfeed, U+000C), NEL (next line, U+0085), LS (line separator, U+2028), and PS (paragraph separator, U+2029).

  

* __`bsr_anycrlf`__ - Specifies specifically that \\R is to match only the CR, LF, or CRLF sequences, not the Unicode-specific newline characters.

* __`bsr_unicode`__ - Specifies specifically that \\R is to match all the Unicode newline characters (including CRLF, and so on, the default).

* __`no_start_optimize`__ - Disables optimization that can malfunction if "Special start-of-pattern items" are present in the regular expression. A typical example would be when matching "DEFABC" against "(*COMMIT)ABC", where the start optimization of PCRE would skip the subject up to "A" and never realize that the (*COMMIT) instruction is to have made the matching fail. This option is only relevant if you use "start-of-pattern items", as discussed in section [PCRE Regular Expression Details](`m:re#regexp_syntax_details`).

* __`ucp`__ - Specifies that Unicode character properties are to be used when resolving \\B, \\b, \\D, \\d, \\S, \\s, \\W and \\w. Without this flag, only ISO Latin-1 properties are used. Using Unicode properties hurts performance, but is semantically correct when working with Unicode characters beyond the ISO Latin-1 range.

* __`never_utf`__ - Specifies that the (*UTF) and/or (*UTF8) "start-of-pattern items" are forbidden. This flag cannot be combined with option `unicode`. Useful if ISO Latin-1 patterns from an external source are to be compiled.
""".
...
-doc """
Executes a regular expression matching, and returns `match/{match, Captured}` or `nomatch`. The regular expression can be specified either as `t:iodata()` in which case it is automatically compiled (as by `compile/2`) and executed, or as a precompiled `t:mp()` in which case it is executed against the subject directly.
...
If the regular expression was previously compiled with option `unicode`, `Subject` is to be provided as a valid Unicode `charlist()`, otherwise any `t:iodata()` will do. If compilation is involved and option `unicode` is specified, both `Subject` and the regular expression are to be specified as valid Unicode `charlists()`.
...
* __`anchored`__ - Limits `run/3` to matching at the first matching position. If a pattern was compiled with `anchored`, or turned out to be anchored by virtue of its contents, it cannot be made unanchored at matching time, hence there is no `unanchored` option.

* __`global`__ - Implements global (repetitive) search (flag `g` in Perl). Each match is returned as a separate `t:list()` containing the specific match and any matching subexpressions (or as specified by option `capture`. The `Captured` part of the return value is hence a `t:list()` of `t:list()`s when this option is specified.
  ...
  * __At offset `0`__ - The regular expression `(|at)` first match at the initial position of string `cat`, giving the result set `[{0,0},{0,0}]` (the second `{0,0}` is because of the subexpression marked by the parentheses). As the length of the match is 0, we do not advance to the next position yet.

  * __At offset `0` with `[anchored, notempty_atstart]`__ - The search is retried with options `[anchored, notempty_atstart]` at the same position, which does not give any interesting result of longer length, so the search position is advanced to the next character (`a`).

  * __At offset `1`__ - The search results in `[{1,0},{1,0}]`, so this search is also repeated with the extra options.

  * __At offset `1` with `[anchored, notempty_atstart]`__ - Alternative `ab` is found and the result is \[\{1,2\},\{1,2\}]. The result is added to the list of results and the position in the search string is advanced two steps.

  * __At offset `3`__ - The search once again matches the empty string, giving `[{3,0},{3,0}]`.

  * __At offset `1` with `[anchored, notempty_atstart]`__ - This gives no result of length > 0 and we are at the last position, so the global search is complete.
...
* __`notempty`__ - An empty string is not considered to be a valid match if this option is specified. If alternatives in the pattern exist, they are tried. If all the alternatives match the empty string, the entire match fails.
...
* __`notempty_atstart`__ - Like `notempty`, except that an empty string match that is not at the start of the subject is permitted. If the pattern is anchored, such a match can occur only if the pattern contains \\K.
...
* __`notbol`__ - Specifies that the first character of the subject string is not the beginning of a line, so the circumflex metacharacter is not to match before it. Setting this without `multiline` (at compile time) causes circumflex never to match. This option only affects the behavior of the circumflex metacharacter. It does not affect \\A.

* __`noteol`__ - Specifies that the end of the subject string is not the end of a line, so the dollar metacharacter is not to match it nor (except in multiline mode) a newline immediately before it. Setting this without `multiline` (at compile time) causes dollar never to match. This option affects only the behavior of the dollar metacharacter. It does not affect \\Z or \\z.

* __`report_errors`__ - Gives better control of the error handling in `run/3`. When specified, compilation errors (if the regular expression is not already compiled) and runtime errors are explicitly returned as an error tuple.

  The following are the possible runtime errors:

  * __`match_limit`__ - The PCRE library sets a limit on how many times the internal match function can be called. Defaults to 10,000,000 in the library compiled for Erlang. If `{error, match_limit}` is returned, the execution of the regular expression has reached this limit. This is normally to be regarded as a `nomatch`, which is the default return value when this occurs, but by specifying `report_errors`, you are informed when the match fails because of too many internal calls.

  * __`match_limit_recursion`__ - This error is very similar to `match_limit`, but occurs when the internal match function of PCRE is "recursively" called more times than the `match_limit_recursion` limit, which defaults to 10,000,000 as well. Notice that as long as the `match_limit` and `match_limit_default` values are kept at the default values, the `match_limit_recursion` error cannot occur, as the `match_limit` error occurs before that (each recursive call is also a call, but not conversely). Both limits can however be changed, either by setting limits directly in the regular expression string (see section [PCRE Regular Eexpression Details](`m:re#regexp_syntax_details`)) or by specifying options to `run/3`.
...
* __`{match_limit, integer() >= 0}`__ - Limits the execution time of a match in an implementation-specific way. It is described as follows by the PCRE documentation:
...
* __`{match_limit_recursion, integer() >= 0}`__ - Limits the execution time and memory consumption of a match in an implementation-specific way, very similar to `match_limit`. It is described as follows by the PCRE documentation:
...
* __`{offset, integer() >= 0}`__ - Start matching at the offset (position) specified in the subject string. The offset is zero-based, so that the default is `{offset,0}` (all of the subject string).
...
* __`{newline, NLSpec}`__ - Overrides the default definition of a newline in the subject string, which is LF (ASCII 10) in Erlang.
  ...
  * __`anycrlf`__ - Any of the three preceding sequences is be recognized.

  * __`any`__ - Any of the newline sequences above, and the Unicode sequences VT (vertical tab, U+000B), FF (formfeed, U+000C), NEL (next line, U+0085), LS (line separator, U+2028), and PS (paragraph separator, U+2029).

  

* __`bsr_anycrlf`__ - Specifies specifically that \\R is to match only the CR LF, or CRLF sequences, not the Unicode-specific newline characters. (Overrides the compilation option.)

* __`bsr_unicode`__ - Specifies specifically that \\R is to match all the Unicode newline characters (including CRLF, and so on, the default). (Overrides the compilation option.)

* __`{capture, ValueSpec}`/`{capture, ValueSpec, Type}`__ - Specifies which captured substrings are returned and in what format. By default, `run/3` captures all of the matching part of the substring and all capturing subpatterns (all of the pattern is automatically captured). The default return type is (zero-based) indexes of the captured parts of the string, specified as `{Offset,Length}` pairs (the `index` `Type` of capturing).
  ...
  * __`ValueSpec`__ - Specifies which captured (sub)patterns are to be returned. `ValueSpec` can either be an atom describing a predefined set of return values, or a list containing the indexes or the names of specific subpatterns to return.

    The following are the predefined sets of subpatterns:

    * __`all`__ - All captured subpatterns including the complete matching string. This is the default.

    * __`all_names`__ - All *named* subpatterns in the regular expression, as if a `t:list()` of all the names *in alphabetical order* was specified. The list of all names can also be retrieved with `inspect/2`.

    * __`first`__ - Only the first captured subpattern, which is always the complete matching part of the subject. All explicitly captured subpatterns are discarded.

    * __`all_but_first`__ - All but the first matching subpattern, that is, all explicitly captured subpatterns, but not the complete matching part of the subject string. This is useful if the regular expression as a whole matches a large part of the subject, but the part you are interested in is in an explicitly captured subpattern. If the return type is `list` or `binary`, not returning subpatterns you are not interested in is a good way to optimize.

    * __`none`__ - Returns no matching subpatterns, gives the single atom `match` as the return value of the function when matching successfully instead of the `{match, list()}` return. Specifying an empty list gives the same behavior.

    The value list is a list of indexes for the subpatterns to return, where index 0 is for all of the pattern, and 1 is for the first explicit capturing subpattern in the regular expression, and so on. When using named captured subpatterns (see below) in the regular expression, one can use `t:atom()`s or `t:string()`s to specify the subpatterns to be returned. For example, consider the regular expression:
...
As in `run/3`, an `t:mp()` compiled with option `unicode` requires `Subject` to be a Unicode `charlist()`. If compilation is done implicitly and the `unicode` compilation option is specified to this function, both the regular expression and `Subject` are to be specified as valid Unicode `charlist()`s.
...
* __`{return,ReturnType}`__ - Specifies how the parts of the original string are presented in the result list. Valid types:

  * __`iodata`__ - The variant of `t:iodata()` that gives the least copying of data with the current implementation (often a binary, but do not depend on it).

  * __`binary`__ - All parts returned as binaries.

  * __`list`__ - All parts returned as lists of characters ("strings").

  

* __`group`__ - Groups together the part of the string with the parts of the string matching the subexpressions of the regular expression.

  The return value from the function is in this case a `t:list()` of `t:list()`s. Each sublist begins with the string picked out of the subject string, followed by the parts matching each of the subexpressions in order of occurrence in the regular expression.

* __`{parts,N}`__ - Specifies the number of parts the subject string is to be split into.
...
* __`trim`__ - Specifies that empty parts at the end of the result list are to be disregarded. The same as specifying `{parts,0}`. This corresponds to the default behavior of the `split` built-in function in Perl.
""".
...
-doc "Same as `replace(Subject, RE, Replacement, [])`.".
...
The permissible options are the same as for `run/3`, except that option` capture` is not allowed. Instead a `{return, ReturnType}` is present. The default return type is `iodata`, constructed in a way to minimize copying. The `iodata` result can be used directly in many I/O operations. If a flat `t:list()` is desired, specify `{return, list}`. If a binary is desired, specify `{return, binary}`.

As in function `run/3`, an `t:mp()` compiled with option `unicode` requires `Subject` to be a Unicode `charlist()`. If compilation is done implicitly and the `unicode` compilation option is specified to this function, both the regular expression and `Subject` are to specified as valid Unicode `charlist()`s.

If the replacement is given as a string, it can contain the special character `&`, which inserts the whole matching expression in the result, and the special sequence `\`N (where N is an integer > 0), `\g`N, or `\g{`N`}`, resulting in the subexpression number N, is inserted in the result. If no subexpression with that number is generated by the regular expression, nothing is inserted.
