...
This function is called for each target in the `Targets` argument of the `c:delivery_targets/3` function, see above.
...
This is the first function called when a notification delivery is in progress. It informs the `receiver` which targets will get the notification. The result of the delivery will be provided via successive calls to `c:delivery_info/4` function, see below.
