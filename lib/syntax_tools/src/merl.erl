...
%% @see compile/1
-spec compile(Code :: term(), Options :: term()) -> term().
...
-spec compile_and_load(Code :: term()) -> term().
...
-spec compile_and_load(Code :: term(), Options :: term()) -> term().
