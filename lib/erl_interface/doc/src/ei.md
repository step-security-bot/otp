...
* __`ei_term`{: id=ei_term }__  
  ...
  Structure written by [`ei_decode_ei_term()`](ei.md#ei_decode_ei_term). The `ei_type` field is the type of the term which equals to what [`ei_get_type()`](ei.md#ei_get_type) sets `*type` to.
