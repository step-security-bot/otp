...
1. *Step 2.* Parameterize the difference in terms of functions that are passed as arguments to the common function.
...
Funs are written with the following syntax (see [Fun Expressions ](`p:system:expressions.md#funs`)for full description):
