...
* This sort of problem can be solved easier by use of the facilities in OTP, which also provide methods for updating code on the fly and so on (see [OTP Design Principles](`p:system:design_principles.md#otp design principles`)).
